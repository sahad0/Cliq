...
const Form3:FC<AppProps> = ({height,width,visibility,setVisibility}) => {
  return (
   <>
    <Text style={{color:'black',margin:height*0.05,fontSize:height*0.021,marginTop:height*0.02,marginBottom:height*0.015}}>Visibility</Text>

    <TouchableOpacity activeOpacity={1} style={{flexDirection:'row',justifyContent:'space-between',margin:height*0.05,marginTop:height*0.002,marginBottom:0}} onPress={() => setVisibility(true)}  >
          <View>
      ...
      <TouchableOpacity activeOpacity={1} style={{flexDirection:'row',justifyContent:'space-between',margin:height*0.05,marginTop:height*0.02}} onPress={() => setVisibility(false)}>
          <View>
