...
const  ChatListHeader:FC<AppProps> = ({height,width}):JSX.Element => {
  ...
  return (
    ...
    <Pressable style={{height:height*0.065,borderColor:'gray',backgroundColor:'white',margin:height*0.018,marginTop:height*0.01,borderRadius:height*0.009,elevation:3,alignItems:'center',flexDirection:'row'}}>
